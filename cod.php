        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <label for="address1">Zip</label><i>(optional)</i>
                <input type="text" id="address1" name="unit" class="form-control" placeholder="(optional)">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <br>
                <select value="Municipality" id="address2" name="address2" style="width:500px; height:40px; font-size:20px;"><option value="Select">Select</option><option value="Bulacan City">Bulacan City</option><option value="Caloocan City">North Caloocan</option><option value="Quezon city">Quezon City</option></select>
            </div>
        </div>
        <p><br/></p>
        <div class="row">
