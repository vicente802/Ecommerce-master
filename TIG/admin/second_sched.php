<?php 
      $firstSql=mysqli_query($conn,"select * from semester where sem_id = '2' "); 
      $secSem = mysqli_fetch_array($firstSql); 
                ...
                <div id="1" class="tabdiv">
                      ...
                      <?php
                        ...
                        <div id="tab-<?= $counter2++; ?>" class=" tab-pane"><br>
                              ...
                              <form method="POST" action="second_sem_print.php<?php echo '?id='.$secRow['major_id']; ?>">
                                ...
                                <tbody>
                                  <?php
                                    $query=mysqli_query($conn,"select * from subject
                                      ...
                                      left join semester on semester.sem_id=subject.subjects_id
                                      where subject.program_id = '".$secRow['major_id']."' AND subject.sem_id='".$secSem['sem_id']."'  ");
                ...
                <div id="2" class="tabdiv" style="display: none;">
                      ...
                      <?php
                        ...
                        <div id="tabs-<?= $counters2++; ?>" class="tab-pane con"><br>
                              ...
                              <form method="POST" action="second_sem_print_maed.php<?php echo '?id='.$srow2['major_id']; ?>">
                                <button type="submit" class="btn btn-warning col-md-2" name="generate_pdf"><i class="fas fa-print"></i> Print Schedule</button>
                              </form>
                            <div style="height: 15px;"></div>    
                            <div> 
                                ...
                                <tbody>
                                  <?php
                                    $query2=mysqli_query($conn,"select * from subject
                                      ...
                                      left join school_year on school_year.school_yr_id=schedule.school_yr_id 
                                      LEFT JOIN semester on semester.sem_id=subject.subjects_id 
                                      where subject.program_id = '".$srow2['major_id']."' AND subject.sem_id='".$secSem['sem_id']."'  ");
