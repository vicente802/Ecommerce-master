<?php include('add_cashier_db.php'); ?>
<head>
    <style type="text/css">
        .error_form0
            {
...
<!-- Add student Modal -->
<div class="modal fade modal-fullscreen" id="add_cashier_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
      
        <!-- Modal Header -->
        <div class="modal-header">
          <center><h4 class="modal-title" id="modalLargespan"> New Cashier</h4></center>
        ...
        <div class="modal-body">
         <div class="container-fluid">
                ...
                <form role="form" method="POST" action="add_cashier_db.php" enctype="multipart/form-data" id="register_form">
