    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <center><h4 class="modal-title" id="modalLargespan"> Edit cashier</h4></center>
        ...
        <div class="modal-body">
         <div class="container-fluid">
          ...
          <?php
              $sq=mysqli_query($conn,"select * from cashier left join user on user.userid=cashier.userid where user.userid='".$trow['userid']."'");
              $trow1=mysqli_fetch_array($sq);
          ?>

                <form role="form" method="POST" action="edit_cashier.php?id=<?php echo $trow['userid']; ?>" enctype="multipart/form-data">
                <div class="col-auto">
                ...
                <div class="col-auto">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input class="form-control" id="form_uname" required="" type="hidden" name="status" placeholder="Username" value="<?php echo ($trow1['status']); ?>">

                            <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success btn-sm" id="edit_form" name="edit"><i class="fa fa-save"></i> | Save Changes</button>
