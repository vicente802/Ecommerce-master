                  ...
                  <div class="container">
                    <div class="col-xl-12">
                        ...
                        <?php
                          ...
                          $studSql=mysqli_query($conn,"select * from student left join app_for_admission on student.userid=app_for_admission.userid left join enrollment on student.userid=enrollment.student_id where enrollment.status = 'Enrolled' AND enrollment.sem_id='1' AND enrollment.AY='".$syRow['school_yr_id']."' " );
            ...
            <?php } elseif ($semRow == $firstRow2) { ?>
                  <div class="container">
                    <div class="col-xl-12">
                        ...
                        <?php
                          $inc=0;
                          $studSql=mysqli_query($conn,"select * from student left join app_for_admission on student.userid=app_for_admission.userid left join enrollment on student.userid=enrollment.student_id where enrollment.status = 'Enrolled' AND enrollment.sem_id='2' AND enrollment.AY='".$syRow['school_yr_id']."' " );
                          while($row=mysqli_fetch_array($studSql)){
          ...
          <?php  } elseif ($semRow == $firstRow3) { ?>
                  <div class="container">
                    <div class="col-xl-12">
                        ...
                        <?php
                          $inc=0;
                          $studSql=mysqli_query($conn,"select * from student left join app_for_admission on student.userid=app_for_admission.userid left join enrollment on student.userid=enrollment.student_id where enrollment.status = 'Enrolled' AND enrollment.sem_id='3' AND enrollment.AY='".$syRow['school_yr_id']."' " );
                          while($row=mysqli_fetch_array($studSql)){
