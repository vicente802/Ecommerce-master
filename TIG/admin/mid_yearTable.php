                ...
                <div id="2" class="tabdiv" style="display: none;">
                    <div class="container">
                      ...
                      <?php
                        ...
                        $subjsql2=mysqli_query($conn,"select * FROM major LEFT JOIN subject on subject.subjects_id=major.major_id LEFT JOIN courses on courses.program_id=subject.subjects_id WHERE major.program_id='2' AND major.sem_id='".$midSem['sem_id']."' ORDER BY major_id ASC");
