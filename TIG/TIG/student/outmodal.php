    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <center><h4 class="modal-title" id="modalLargespan"> Logging out</h4></center>
        ...
        <div class="modal-body">
         <div class="container-fluid">
                        ...
                        <div class="col-auto">
                          ...
                          <p><center>Account: <strong><?php echo $fullname; ?></strong></center></p>
                        </div>
  ...
  <div class="modal fade" id="cancel">
    <div class="modal-dialog">
      ...
      <div class="container-fluid">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
            <a href="admission.php" class="btn btn-danger">Yes</a>
