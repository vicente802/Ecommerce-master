        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <form method="POST" action="student_edit_information.php<?php echo '?id='.$row['userid']; ?>">
                        ...
                        <center>
                           <button type="submit" name="updateInfo" class="btn btn-success btn-sm"><i class="fas fa-save"></i>  | Save changes</button>
