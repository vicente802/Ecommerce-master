<?php 
      ...
      $countSql=mysqli_query($conn,"select * from enrolled_subject where schedule_id  "); 
              	...
              	<div id="1" class="tabdiv">
                      ...
                      <?php
                        ...
                        <div id="tab-<?= $counter2++; ?>" class=" tab-pane"><br>
                              ...
                              <form method="POST" action="first_sem_print.php<?php echo '?id='.$srow['major_id']; ?>">
                ...
                <div id="2" class="tabdiv" style="display: none;">
                      ...
                      <?php
                        ...
                        <div id="tabs-<?= $counters2++; ?>" class="tab-pane"><br>
                              <form method="POST" action="first_sem_print_maed.php<?php echo '?id='.$srow2['major_id']; ?>">
