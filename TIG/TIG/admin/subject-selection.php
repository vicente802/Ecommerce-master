...
if (isset($_POST['add_btn'])) {
	...
	if (($_POST['schedule']) == "----Select subject----") {
...
<?php	}else{
			...
			mysqli_query($conn,"insert into enrolled_subject (schedule_id, school_yr_id, sem_id, userid) values ('$schedule', '$school_yr_id', '$semester', '$id')");
