...
if(isset($_POST['edit'])){
	...
	$ed = mysqli_query($conn, "select * from admin where userid = '$id'");
	...
	mysqli_query($conn,"update admin set fullname='$fullname', contact_number='$contact_number', image='$location' where userid='$id'");
