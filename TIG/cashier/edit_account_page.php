      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <div class="container-fluid">
            ...
            <?php
                  $sq=mysqli_query($conn,"select * from cashier left join user on user.userid=cashier.userid where user.userid='".$_SESSION['id']."'");
              ...
              <form method="POST" action="edit_prof.php?id=<?php echo $arow1['userid']; ?>" id="edit_form" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="submit" name="edit" id="edit_btn" class="btn btn-success"><i class="fas fa-edit" style="text-decoration: none;"></i> Save changes</button>
