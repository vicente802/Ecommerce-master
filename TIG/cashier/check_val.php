<?php 
  ...
  if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
      ...
      mysqli_query($conn,"insert into user (username, password, position) values ('$username', '$password', 'Student')");
      $userid=mysqli_insert_id($conn);
      mysqli_query($conn,"insert into admin (userid, fullname, contact_number, image) values ('$userid','$fullname', '$contact_number', '$location')");
