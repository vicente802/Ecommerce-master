                ...
                if (resp.status == 202) {
                    ...
                    $.each(resp.message, function(index, value) {
                        ...
                        customerOrderHTML += '<tr>' +
                            ...
                            '<td><form action="./classes/update.php" method="POST"><input type="hidden" name="product_title" value=' + value.product_title + '><input type="hidden" name="email" value=' + value.email + '><input type="hidden" name="user_id" value=' + value.user_id + '><input type="hidden" name="product_id" value=' + value.product_id + '><input type="hidden" name="order" value=' + value.order_id + '><input type="hidden" name="trx" value=' + value.trx_id + '><input type="hidden" name="p_status" value=' + value.p_status + '><input type="hidden" name="shipping" value=' + value.shipping + '><input type="hidden" name="payment_method" value=' + value.payment_method + '><input type="hidden" name="qty1" value=' + value.qty + '><input type="hidden" name="price" value=' + total + '> <input type="submit" class="btn btn-primary" value="update"></form></td>' +
