                ...
                if (resp.status == 202) {
                    ...
                    $.each(resp.message, function(index, value) {
                        ...
                        customerOrderHTML += '<tr>' +
                            ...
                            '<td><form action="./classes/Customers.php" method="POST"><input type="hidden" name="order" value=' + value.order_id + '><select name="status" value="status" id="status"><option value="Queue">Status</option><option value="Preparing..." >Preparing</option><option value="Shipping.." >Shipped</option></select> <input type="submit" value="update"></form></td>' +
