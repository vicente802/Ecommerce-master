...
$sql1 = "INSERT INTO preparing (email,product_id,qty,trx_id,p_status,shipping,cancel,payment_method) VALUES ('$email','".$product_id."','".$qty."','$trx','$p_status','$shipping','$cancel','$payment_method')";
