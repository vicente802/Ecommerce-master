    ...
    if (isset($_POST["checkOutDetails"])) {
        ...
        if (mysqli_num_rows($query) > 0) {
                ...
                echo
                    '<br>
                        ...
                        <div class="col-md-1"></div>
								...
								<div class="col-md-1"><input type="number" min="1" class="form-control qty" value="' . $qty . '" ></div>
								<div class="col-md-1"><input type="text" class="form-control total" value="' . $product_price . '" readonly="readonly"></div>
                              
                                <div class="col-md-2" style="margin-left:0px;></div>
                                <div class="col-md-4">
                                <div class="btn-group">
            ...
            if (!isset($_SESSION["uid"])) {
                ...
                <div class="col-md-6"></div>
                <div class="col-md-3">
					<button class="btn btn-primary"style="float:center; text-align:center; font-size:30px; ">Place Order</button>
					</div></form>
                    </div>
                    </div>
                    </div>
